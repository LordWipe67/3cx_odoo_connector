odoo.define('threecx.ThreeCXPhoneTrayIcon', function (require) {
    ...
    ////////////////////////////////////////
//  estende il widget per visualizzare popup e pulsanti
...
//                Mantieni la vista "modulo" solo per mostrare le informazioni di dettaglio del partner
                var views = r.views;
...
//          qui chiama la funzione che aprirà il popup
            this._rpc({
                route: '/web/action/load',
                params: {
